...
describe ('check-exisiting component checks if message_id already exisis in database ', () => {
    ...
    beforeEach(async ()=> {
        ...
        recordOne = await models.Request.create({ album: '12345', url: 'http://testphoto.com', account_id: 51, franchisor_id: 6, photo_id: 333, type: 'tag', receipt_handle: '222222', message_id: '4444444', tag: 'pet', request_success: true})
        recordTwo = await models.Request.create({ album: '67890', url: 'http://testphoto.com', account_id: 52, franchisor_id: 7, photo_id: 444, type: 'tag', receipt_handle: '222222', message_id: '555555', tag: 'pet'})
